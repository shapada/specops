...
get_header(); ?>
  ...
  ?>
  <div class="page-banner" style="background: #154865; padding: 40px 0 30px;">
    <div class="row">
      <div class="columns-10 column-center text-center banner-col">
        ...
        <a href="#Videos" class="see-all-resource"><img src="https://specopsdev2.wpengine.com/wp-content/uploads/2019/08/video.png">View All Videos</a>
        <a href="#Datasheets" class="see-all-resource"><img src="https://specopsdev2.wpengine.com/wp-content/uploads/2019/08/datasheet.png">View All Datasheets</a>
        <a href="#Whitepapers" class="see-all-resource"><img src="https://specopsdev2.wpengine.com/wp-content/uploads/2019/08/whitepaper.png">View All Whitepapers</a>
      </div>
    </div>
  </div>
		...
		<div class="row-resources">
            ...
            if($second_query->have_posts()): while($second_query->have_posts()): $second_query->the_post();
              ...
              foreach($resource_types as $resource_type):
                ...
                if(array_key_exists($resource_type->name, $theContent)) {
                  ...
                  }else if($resource_type->name == 'Whitepapers') {
          ...
          <?
            ...
            foreach($theContent as $key => $value) :
              $videoUrl = '';
            if($key == 'Videos') {
              $titleIcon = 'https://specopsdev2.wpengine.com/wp-content/uploads/2019/08/video.png';
            }else if($key == 'Whitepapers') {
              $titleIcon = 'https://specopsdev2.wpengine.com/wp-content/uploads/2019/08/whitepaper.png';
            }else {
              $titleIcon = 'https://specopsdev2.wpengine.com/wp-content/uploads/2019/08/datasheet.png';
            }
          ?>
          ...
          <?php foreach($value as $subKey => $subValue) : ?>
            <? if($key == 'Videos') : ?>
              <a href="<?php echo $subValue['permalink']; ?>"><div class="resource-inline"><div class="resource-image-overlay"><img src="<?php echo $subValue['video_image']; ?>"></div><h4><?php echo $subValue['title']; ?></h4></div></a>
            <? else: ?>

		...
		<div class="row-resources">
          ...
          ?>
			<div class="resource-section" id="<?php echo $key; ?>">
				<h2>
					<img src="<?php echo esc_url( $titleIcon ); ?>"><?php echo esc_html( $key ); ?>
				</h2>

				<div class="<?php echo 'Videos' === $key ? 'video-wrapper' : 'resource-wrapper'; ?>">
					<?php foreach ($value as $subKey => $subValue) : ?>
						<a href="<?php echo $subValue['permalink']; ?>">
							<div class="resource-inline">
								<?php if ( 'Videos' === $key ) : ?>
									<div class="resource-image-overlay">
										<img src="<?php echo esc_url( array_key_exists( 'video_image', $subValue ) ? $subValue['video_image'] : get_template_directory_uri() . '/images/vid-placeholder.jpg'); ?>">
									</div>
									<h4>
										<?php echo esc_html( $subValue['title'] ); ?>
									</h4>
									<?php else: ?>
									<div class="background-<?php echo $key; ?>">
										<h4><?php echo esc_html( $subValue['title'] ); ?></h4>
									</div>
									<div class="excerpt-parent">
										<p class="excerpt">
											<?php echo esc_html( $subValue['excerpt'] );?>
										</p>
									</div>
								<?php  endif; ?>
							</div>

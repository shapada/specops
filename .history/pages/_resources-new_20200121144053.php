	...
	<section class="resources-results">
		...
		<div class="row-resources">
          ...
          <?php foreach($value as $subKey => $subValue) : ?>
            <? if($key == 'Videos') : ?>
              <a href="<?php echo $subValue['permalink']; ?>"><div class="resource-inline"><div class="resource-image-overlay"><img src="<?php if(array_key_exists('video_image', $subValue)) {echo $subValue['video_image'];} else { echo get_template_directory_uri() . '/images/vid-placeholder.jpg';} ?>"></div><h4><?php echo $subValue['title']; ?></h4></div></a>
            <? else: ?>

...
function single_product_enqueue_scripts()
{
	...
	if ( 'resources' === get_post_type() && is_single() && has_term( 'datasheets', 'resource-types' ) ) {
		wp_enqueue_style( 'tablesawcss', get_stylesheet_directory_uri() . '/scripts/vendor/tablesaw/tablesaw.stackonly.css' );
	 	//wp_enqueue_script( 'tablesawjs-stack', get_stylesheet_directory_uri() . '/scripts/vendor/tablesaw/tablesaw.stackonly.jquery.js', [ 'jquery' ] );
	 	wp_enqueue_script( 'tablesawjs-init', get_stylesheet_directory_uri() . '/scripts/vendor/tablesaw/tablesaw.stackonly.js' );
	}
}

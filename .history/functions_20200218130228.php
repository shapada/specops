...
function single_product_enqueue_scripts()
{
	...
	if ( 'resources' === get_post_type() && has_term( 'datasheets', 'resource-types' ) ) {
		wp_enqueue_style( 'tablesaw-css', get_stylesheet_directory_uri() . '/scripts/vendor/tablesaw/tablesaw.stackonly.css' );
	 	wp_enqueue_script( 'tablesaw-stack', get_stylesheet_directory_uri() . '/scripts/vendor/tablesaw/tablesaw.stackonly.jquery.js', [ 'jquery' ] );
	 	wp_enqueue_script( 'tablesaw-js', get_stylesheet_directory_uri() . '/scripts/vendor/tablesaw/tablesaw.stackonly.js' );
	}
}

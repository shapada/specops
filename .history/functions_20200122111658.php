...
function single_product_enqueue_scripts()
{
	...
	if ( 'resources' === get_post_type() && is_single() ) {
		wp_enqueue_style( 'tablesawcss', '//cdnjs.cloudflare.com/ajax/libs/tablesaw/3.1.2/stackonly/tablesaw.stackonly.min.css' );
	 	wp_enqueue_script( 'tablesawjs', '//cdnjs.cloudflare.com/ajax/libs/tablesaw/3.1.2/stackonly/tablesaw.stackonly.min.js');
	 	wp_enqueue_script( 'tablesawjs', '//filamentgroup.github.io/tablesaw/dist/tablesaw-init.js');
	}
}

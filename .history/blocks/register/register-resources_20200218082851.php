...
function register_resources_blocks()
{
    if (function_exists('acf_register_block_type')) {
		...
		acf_register_block_type([
            'name'				=> 'intro-text',
            'title'				=> 'Intro Text',
            'description'		=> 'A block containing intro text for a single resource item.',
            'render_callback'	=> 'acf_block_render_callback',
            'mode'				=> 'auto',
            'category'			=> 'resources',
            'post_types'		=> [ 'resources' ],
            'icon'				=> 'format-aside',
            'keywords'			=> [ 'resources', 'resource', 'resources text', 'resource text', 'intro', 'intro text', 'text', 'text intro' ],
		]);
    }
}

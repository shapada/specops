        ...
        <div class="columns-12">
            <form class="blog-search-form row" method="get" action="<?php echo get_permalink(12); ?>" >
                <div class="columns-3 right-1 keyword-column">
                    <label for="keyword" style="color: $color-charcoal;"><?php _e('Search', 'anvil'); ?></label>
                    <input type="text" name="keywords" id="keyword" value="<?php echo isset($_GET['keywords'])? $_GET['keywords'] : ''; ?>" style="background: $color-white;" />
                </div>
                <div class="columns-3 right-1 postdate-column">
                    <label for="postdate" style="color: $color-charcoal;"><?php _e('Date', 'anvil'); ?></label>
                    <select name="postdate" id="postdate" style="background: $color-white;">
                ...
                <div class="columns-3 right-1 tags-column">
                    <label for="post-tag" style="color: $color-charcoal;"><?php _e('Tags', 'anvil'); ?></label>
                    <select name="post-tag" id="post-tag" style="background: $color-white;">
                        <option value=""><?php _e('Show All', 'anvil'); ?></option>

...
<style>
    ...
    .page-template-_thank-you .entry-content {
        padding: 0;
    }
    .page-template-_thank-you .entry-content p {
        font-size: 16px;
        line-height: 1.25em;
        margin-top: 20px;
        font-style: normal;
    }
    .page-template-_thank-you .ti-page-hero {
        height: 100%;
        background: #134D6D;
    ...
    .page-template-_thank-you .ti-page-hero .ti-green-large {
        font-size: 62px;
        color: #D1DB2D;
        line-height: 1;
    }
    .page-template-_thank-you .ti-page-hero,
    .page-template-_thank-you .latest-blogs {
        position: relative;
        z-index: 1;
        left: 50%;
        right: 50%;
    ...
    .page-template-_thank-you .ti-content {
        margin-top: 0;
        padding: 80px 0;
    }
    .page-template-_thank-you .latest-blogs ul.blog-posts{
        margin: 0 30px;
    }
    #searchform {
        width: 75%;
    ...
    .page-template-_thank-you .ti-page-hero h2 {font-weight: 400;}
    .page-template-_thank-you .ti-max-width-container {
        max-width: 800px;
        margin: 0 auto;
    }
...
<style scoped>
    @media (max-width: 768px) {
        ...
        .page-template-_thank-you .ti-content .ti-single p {
            vertical-align: top;
            margin-top: 40px;
            font-weight: bold;
            text-align: left;
        ...
        .page-template-_thank-you .s404 input[type=search] {
            width: 95%;
            padding: 10px;
            margin-bottom: 10px;
        }
        ...
        .page-template-_thank-you .latest-blogs ul.blog-posts {margin: 0 5px;}
